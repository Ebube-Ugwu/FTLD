...
contract VotingContract {
    ...
    function getCandidate(uint256 _id) view private returns (Candidate memory) {
    ...
    function getCandidateWithHighestVote() view public returns (Candidate memory) {
    ...
    function checkIfVoterIsRegistered(address voter) view public returns (bool) {
